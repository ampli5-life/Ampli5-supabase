    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          <motion.span
            ...
            className="inline-flex items-center gap-2 text-[hsl(199,89%,48%)] text-xs font-bold tracking-[0.3em] uppercase mb-6"
          >
          ...
          >
            {stats.map((s, i) => (
              <div key={i} className="text-center">
                <p className="text-3xl md:text-4xl font-bold text-[hsl(199,89%,48%)] dark:text-primary mb-1">{s.value}</p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid items-center gap-16 md:grid-cols-2">
          ...
          >
            ...
            <Link to="/free-videos">
              <Button className="rounded-full bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] hover:bg-[hsl(199,89%,43%)] px-8 h-12 font-bold transition-all duration-300 hover:scale-105 active:scale-95">
          ...
          >
            ...
            >
              <p className="text-3xl font-bold text-[hsl(199,89%,48%)] dark:text-primary mb-1">5+ yrs</p>
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center text-primary-foreground dark:text-foreground">
          ...
          >
            <Link to="/pricing">
              <Button size="lg" className="rounded-full bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] hover:bg-[hsl(199,89%,43%)] px-10 h-14 text-base font-bold shadow-[0_0_40px_rgba(14,165,233,0.25)] transition-all duration-300 hover:scale-105 active:scale-95">
                Start Free Trial
              </Button>
            </Link>
          </motion.div>
