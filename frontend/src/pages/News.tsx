        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[hsl(71,95%,60%)]/15 flex items-center justify-center">
                  <CalendarDays className="h-5 w-5 text-[hsl(71,95%,60%)] dark:text-primary" />
                </div>
            ...
            <div>
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[hsl(71,95%,60%)]/15 flex items-center justify-center">
                  <Calendar className="h-5 w-5 text-[hsl(71,95%,60%)] dark:text-primary" />
                </div>
