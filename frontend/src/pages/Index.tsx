                  ...
                  <Link to={`/free-videos/${video.id}`} className="block">
                    ...
                    <div className="relative rounded-2xl overflow-hidden aspect-[4/3] mb-5 bg-muted">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="inline-flex items-center gap-1 bg-white/95 dark:bg-black/60 dark:backdrop-blur-md dark:text-white text-[hsl(222,47%,12%)] text-[11px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest shadow-sm">
