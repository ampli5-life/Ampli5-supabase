            ...
            {plans.map((plan, i) => (
              <motion.div key={plan.id} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <Card className={`relative flex h-full flex-col border-2 rounded-3xl overflow-hidden card-hover ${plan.popular
                    ? "border-[hsl(199,89%,48%)] shadow-lg dark:shadow-[0_0_30px_rgba(14,165,233,0.08)]"
                    : "border-border/50 shadow-sm"
                  }`}>
                  {plan.popular && (
                    <div className="absolute -top-px left-0 right-0 h-1 bg-gradient-to-r from-[hsl(199,89%,48%)] via-[hsl(199,89%,38%)] to-[hsl(199,89%,48%)]" />
                  )}
                  {plan.popular && (
                    <div className="absolute top-4 right-4">
                      <span className="inline-flex items-center gap-1.5 bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] text-[11px] font-bold px-3 py-1.5 rounded-full uppercase tracking-wider">
                    ...
                    <ul className="space-y-4">
                      {plan.features.map((f) => (
                        <li key={f} className="flex items-center gap-3 text-sm">
                          <div className="w-5 h-5 rounded-full bg-[hsl(199,89%,48%)]/15 flex items-center justify-center shrink-0">
                            <Check className="h-3 w-3 text-[hsl(199,89%,48%)] dark:text-primary" />
                          </div>
                          {f}
                        </li>
                      ))}
                  ...
                  <CardFooter className="px-8 pb-8">
                    <Button
                      className={`w-full rounded-full h-12 font-bold transition-all duration-300 hover:scale-[1.02] active:scale-95 ${plan.popular
                          ? "bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] hover:bg-[hsl(199,89%,43%)] shadow-md"
                          : ""
                        }`}
      ...
      {paidVideos.length > 0 && (
        <section className="py-20 bg-muted/50 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <span className="text-[hsl(199,89%,48%)] dark:text-primary text-xs font-bold tracking-[0.3em] uppercase block mb-4">
                      ...
                      <div className="relative aspect-video overflow-hidden bg-muted">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <motion.div
                            ...
                            className="w-14 h-14 rounded-full bg-[hsl(199,89%,48%)]/90 flex items-center justify-center shadow-2xl backdrop-blur-sm"
                          >
                        ...
                        <div className="absolute left-3 top-3">
                          <span className="inline-flex items-center gap-1.5 bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest shadow-sm">
