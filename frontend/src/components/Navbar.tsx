            ...
            profile ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(71,95%,60%)] ring-offset-2 ring-offset-background transition-transform hover:scale-105 active:scale-95">
              ...
              <>
                ...
                <Button asChild className="rounded-full font-bold px-6 text-[13px] bg-[hsl(71,95%,60%)] text-[hsl(155,40%,12%)] hover:bg-[hsl(71,95%,55%)] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 active:scale-95">
            ...
            <div className="p-4 flex flex-col gap-2">
              {profile ? (
                ...
                <>
                  ...
                  <Button asChild className="w-full rounded-full h-12 font-bold bg-[hsl(71,95%,60%)] text-[hsl(155,40%,12%)] hover:bg-[hsl(71,95%,55%)]">
