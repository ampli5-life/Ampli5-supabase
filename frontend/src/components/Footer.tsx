      ...
      <div className="grid gap-12 md:grid-cols-4 lg:grid-cols-5 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li><Link to="/free-videos" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">Browse Classes</Link></li>
            <li><Link to="/news" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">News & Events</Link></li>
            <li><Link to="/pricing" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">Pricing</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li><Link to="/about" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">About Us</Link></li>
            <li><Link to="/blog" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">Blog</Link></li>
            <li><Link to="/contact" className="text-current/50 hover:text-[hsl(199,89%,48%)] transition-colors duration-300">Contact</Link></li>
          </ul>
        </div>
        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex flex-col gap-3">
            <Input
              ...
              className="bg-white/5 border-white/10 text-current placeholder:text-current/30 focus:border-[hsl(199,89%,48%)]/50 focus:ring-[hsl(199,89%,48%)]/50 rounded-full h-12 px-5"
            />
            <Button className="w-full bg-[hsl(199,89%,48%)] text-[hsl(222,47%,12%)] hover:bg-[hsl(199,89%,43%)] font-bold rounded-full h-12 transition-all duration-300 active:scale-95 hover:shadow-md">
